...
const HERO_IMAGE = "/images/hero/real-morning.jpg";
  ...
  return (
    ...
    >
      ...
      <Box sx={{ position: "relative", display: { xs: "none", md: "block" }, overflow: "hidden" }}>
        ...
        />
        <Box sx={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(8,12,14,0.35) 0%, rgba(8,12,14,0.6) 100%)" }} />
        <Box className="hero-grain" />

        <Stack sx={{ position: "relative", zIndex: 2, height: "100%", p: { md: 5, lg: 7 }, color: "#f5f3ee" }} justifyContent="space-between">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease }}>
            <Typography
              onClick={() => navigate("/")}
              className="font-display"
              sx={{ cursor: "pointer", fontSize: "1.625rem", letterSpacing: "-0.03em", lineHeight: 1 }}
            >
          ...
          <Stack spacing={3} sx={{ maxWidth: 520 }}>
            ...
            <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease, delay: 0.25 }}>
              <Typography
                className="font-display"
                sx={{ fontSize: { md: "2.75rem", lg: "3.5rem" }, lineHeight: 1.05, letterSpacing: "-0.03em", fontWeight: 400 }}
              >
                Start with{" "}
      ...
      >
        ...
        >
          <Stack spacing={5}>
            <Box>
              <Typography
                sx={{ fontSize: 10, letterSpacing: "0.3em", textTransform: "uppercase", color: inkSoft, fontWeight: 500, mb: 2 }}
              >
                Register
              </Typography>
              <Typography
                className="font-display"
                sx={{ fontSize: { xs: "2.25rem", md: "2.75rem" }, lineHeight: 1.05, letterSpacing: "-0.03em", fontWeight: 400, mb: 1.5 }}
              >
                Create your account.
              </Typography>
              ...
              <Stack spacing={4}>
                ...
                <Stack direction="row" spacing={3} alignItems="center" sx={{ pt: 2 }}>
                  <Button
                    ...
                    disabled={loading}
                    endIcon={
                      loading ? <CircularProgress size={14} sx={{ color: "inherit" }} /> : <ArrowForwardIcon sx={{ fontSize: 16 }} />
                    }
                    sx={{
                      bgcolor: ink,
                      color: bg,
